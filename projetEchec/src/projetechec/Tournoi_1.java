...
public class Tournoi_1 {
    ...
    public Tournoi_1(String nomT,String dateDebutT,String dateFinT, int nbRoundT, String lieuT){
        nomTournoi=nomT;
    ...
    public Tournoi_1(String nomT,String dateDebutT,String dateFinT, String nbRoundT, String lieuT){
        nomTournoi=nomT;
        dateDebut=dateDebutT;
        dateFin=dateFinT;
        if("".equals(nbRoundT)){
