...
public class ControllerTournoi {
    ...
    public static String[] enregistrerModifsTournoi(String nomTournoi,String dateDebut,String dateFin,String nbRondes,String lieu, int IDT){
        Tournoi t = new Tournoi(nomTournoi,dateDebut,dateFin,nbRondes,lieu);
        boolean test = true ;
        String stmp[] = new String[7];
        stmp[0] = "Données incorrectes: ";
        ...
        if(test){
            stmp[0] ="Tournoi créé avec succès !";       
            xmlTournoi.modifierTournoi(IDT,t);
        }
        return stmp;
    }
